...
class IsilonSMB(object):
    ...
    def create_permissions_object(self, permission_names, permissions, type):
        ...
        try:
            ...
            LOG.info("Exit create_permissions list_permissions : "
                     "{0}".format(list_permissions))
    ...
    def validate_permission_dict(self):
        ...
        LOG.info("Default provider_type added to permission  : {0}".format(
            self.module.params['permissions']))
    ...
    def perform_module_operation(self):
        ...
        if state == 'present' and not smb_details:
            LOG.info("Creating new SMB share {0}".format(share_name))
        ...
        if state == 'absent' and smb_details:
            LOG.info("Deleting SMB share {0}".format(share_name))
